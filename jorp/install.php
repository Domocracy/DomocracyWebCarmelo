...
if (isset($_POST['submit'])) {
	...
	if (table_exists(users, "".$_POST['db_name'])."") {
		echo "<b>Jorp is already installed. Please delete the file \"install.php\".</b>";
	}
	...
	echo "<div id=\"contentContainer\">
		...
		echo "Jorp has been installed successfully. You may now log in <a href=\"index.php\">here</a> with the username \"Administrator\" and the password \"password\".";
	...
	echo 		"<label for=\"db_host\">MySQL Hostname: </label><input type=\"text\" value=\"\" maxlength=\"150\" name=\"db_host\"/><br />\n";
 	...
 	echo 		"<input type=\"submit\" name=\"submit\" value=\"Install Jorp\" class=\"send\"/>";
